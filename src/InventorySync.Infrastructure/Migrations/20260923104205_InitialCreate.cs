        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ErpRecordId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedDateUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SyncAuditEntries_SyncRuns_SyncRunId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryItems_WarehouseCode_LastSyncedUtc",
                table: "InventoryItems",
                columns: new[] { "WarehouseCode", "LastSyncedUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SyncAuditEntries_SyncRunId_EntityType",
                table: "SyncAuditEntries",
                columns: new[] { "SyncRunId", "EntityType" });

            migrationBuilder.CreateIndex(
                name: "IX_SyncRuns_EntityType_StartedUtc",
                table: "SyncRuns",
                columns: new[] { "EntityType", "StartedUtc" });
        }
